			...
			<div class="jumbotron">
				...
				<form class="form-inline" role="form">
				  <div class="form-group">
					<label class="sr-only" for="exampleInput">扫描地址</label>
					<input style="width:400px;" type="input" class="form-control" id="exampleInput" placeholder="扫描地址： http://www.abc.com/">
				  </div>
				...
				<table class="table table-hover table-bordered text-center">
				  <thead>
					<tr>
					  ...
					  <th width="60px" class="text-center">漏洞</th>
...
<tr>
  ...
  <td><?php echo count($value->issue_digests) ?></td>
  <td><?php echo $value->status ?></td>
  <td><?php echo $value->active? "运行中":"停止" ?></td>
  <td>
	<a href="issue.php?id=<?php echo $value->id ?>"><button type="button" class="btn btn-primary btn-xs">报告 </button></a>
